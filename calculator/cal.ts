...
if (question.operator == "+") {
  console.log(
    `sum of given two numbers is ${sum(question.num1, question.num2)}`
  );
} else if (question.operator == "-") {
  console.log(
    `difference of given two numbers is ${difference(
      question.num1,
      question.num2
    )}`
  );
  ...
  console.log(
    `product of given two numbers is ${product(question.num1, question.num2)}`
  );
} else if (question.operator == "/") {
  console.log(
    `division of given two numbers is ${division(question.num1, question.num2)}`
  );
} else {
  console.log("INVALID !!!");
};
